...
int main()
{
    ...
    std::cout << "Es war einmal ein Koenigreich, in dem war seit einem Jahr die "
              ...
              << std::endl; // erster Satz, neue Sätze in diesem Kapitel erst
                            // unter diesem Satz
    std::cout << "Der Koenig war verzweifelt auf der Suche nach einer Loesung, doch niemand den er fragte, konnte ihm helfen."
              << std::endl;
    /*
     * Viertes Kapitel
     */
   ...
   std:cout
        ...
        << std::endl;
   std:cout
         << "Eines Tages wachten alle drei überrascht auf."
          << std::endl;
